...
const projects = [
  ['01', 'Unity / Creative App', 'appTomau2', 'A Unity drawing and colouring app built around simple, accessible creative play.', ['Unity', 'C#', 'UI'], '◈', 'https://github.com/NVMHung/appTomau2', '/projects/apptomau-review.mp4', '/projects/apptomau2.mp4', 'Designed and implemented a lightweight drawing experience: user input, colour selection, brush interaction, and a clear Unity UI flow for approachable creative play.', [['00:00', 0, 'App overview'], ['00:12', 12, 'Drawing interaction'], ['00:28', 28, 'Colouring workflow']]],
  ['02', 'Unity / Adventure', 'Adventure Game', 'A Unity movement and puzzle-solving prototype focused on player control and level interaction.', ['Unity', 'C#', 'Puzzle'], '⌘', 'https://github.com/NVMHung/AdventureGame', '/projects/run-review.mp4', '/projects/run2.mp4', 'Built player movement and interaction foundations for an exploration puzzle game, with an emphasis on readable controls, environmental challenges, and iteration in Unity.', [['00:00', 0, 'Movement overview'], ['00:10', 10, 'Puzzle interaction'], ['00:25', 25, 'Level walkthrough']]],
  ['03', 'Unity / Racing', 'Pig Racing 2.0', 'A playful Unity race app where multiple pigs compete across a simple race track.', ['Unity', 'C#', 'Gameplay'], '↗', 'https://github.com/NVMHung/appHeoracing2.0', '/projects/heo-race-review.mp4', '/projects/heo-race2.mp4', 'Created a multi-pig racing experience with race setup, movement behaviour, finish-state feedback, and a focused gameplay loop designed for quick, understandable sessions.', [['00:00', 0, 'Race setup'], ['00:11', 11, 'Racing behaviour'], ['00:26', 26, 'Finish-state flow']]],
];
